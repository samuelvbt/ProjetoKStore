...
public class ProdutoAdapter extends ArrayAdapter<ProdutoPOJO> {
    Bundle bundlePedido;
    PedidoController pedidoController;
    boolean produtoNoPedido = false;
    public ProdutoAdapter(Context context, List<ProdutoPOJO> produtos,Bundle bundle) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        convertView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                List<ItemPedidoInterfacePOJO> itens =  pedidoController.buscaItens(bundlePedido.getString("idPedido"),produtoClicado.getCodigoProduto());
                if(!itens.isEmpty()){
